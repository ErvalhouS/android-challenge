...
public class OAuthTask extends AsyncTask<Void, Integer, String> {
	...
	private static final Uri OAUTH_CALLBACK_URI = Uri.parse(AndroidChallengeActivity.CALLBACK_SCHEME
			+ "://oauth"); //$NON-NLS-1$
	...
	protected void onPreExecute() {
		...
		mProgressDialog = ProgressDialog.show(mContext,
				"", "Realizando autenticação no Flickr..."); //$NON-NLS-1$ //$NON-NLS-2$
	...
	private void saveTokenSecrent(String tokenSecret) {
		...
		AndroidChallengeActivity act = (AndroidChallengeActivity) mContext;
